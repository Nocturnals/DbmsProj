...
List createPlaylist() {
  ...
  playlistSongs
      .add(Song('1','You Belong With Me', 3.4, '01', '01', '01').fromSongtoList());
  playlistSongs
      .add(Song('2','We don\'t talk anymore', 4.4, '01', '01', '01').fromSongtoList());
  playlistSongs
      .add(Song('3','You Belong With Me', 5.4, '01', '01', '01').fromSongtoList());
  playlistSongs
      .add(Song('4','You Belong With Me', 3.4, '01', '01', '01').fromSongtoList());
  playlistSongs
      .add(Song('5','You Belong With Me', 3.4, '01', '01', '01').fromSongtoList());
